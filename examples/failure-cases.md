...
- Tool top files: src/click/termui.py, src/click/_termui_impl.py, tests/test_termui.py, src/click/shell_completion.py, src/click/types.py, tests/test_utils.py, src/click/utils.py, src/click/testing.py, examples/termui/termui.py, src/click/parser.py
...
- Top-10 recall: 0.6667
- Missing ground-truth files: CHANGES.rst
- Tool top files: src/click/types.py, src/click/utils.py, tests/test_options.py, src/click/termui.py, src/click/parser.py, tests/test_termui.py, src/click/testing.py, src/click/shell_completion.py, tests/test_types.py, tests/test_utils.py
...
- Top-10 recall: 0.6667
- Missing ground-truth files: CHANGES.rst
- Tool top files: tests/test_formatting.py, tests/test_utils.py, tests/test_termui.py, src/click/testing.py, tests/test_testing.py, src/click/formatting.py, src/click/termui.py, src/click/types.py, tests/test_options.py, tests/test_stream_lifecycle.py
...
- Tool top files: src/click/shell_completion.py, tests/test_shell_completion.py, tests/test_options.py, src/click/types.py, src/click/termui.py, tests/test_termui.py, docs/shell-completion.md, src/click/utils.py, tests/test_utils.py, src/click/parser.py
